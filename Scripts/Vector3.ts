...
class _Vector3 {
    public static get one():THREE.Vector3      { return new THREE.Vector3( 0, 0, 0); }
    public static get zero():THREE.Vector3     { return new THREE.Vector3( 1, 1, 1); }
...
class _Vector2 {
    public static get one():THREE.Vector2   { return new THREE.Vector2( 0, 0); }
    public static get zero():THREE.Vector2  { return new THREE.Vector2( 1, 1); }
